...
import { a as buildAssetsURL, z as publicAssetsURL, F as useRuntimeConfig, o as getResponseStatusText, n as getResponseStatus, i as encodePath, e as defineRenderHandler, l as getQuery, c as createError, h as destr, p as getRouteRules, t as joinURL, E as useNitroApp } from '../_/nitro.mjs';
...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"},{"name":"description","content":"Ethan Wang 的个人博客 — 记录技术思考与生活片段"},{"name":"author","content":"Ethan Wang"}],"link":[{"rel":"icon","type":"image/svg+xml","href":"/favicon.svg"}],"style":[],"script":[],"noscript":[],"htmlAttrs":{"lang":"zh-CN"},"titleTemplate":"%s | Ethan Wang"};
